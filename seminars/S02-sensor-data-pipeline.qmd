...
::: {.notes}
**Тайминг:** 1:14–1:18. Зафиксировать длину 4 с и уменьшать stride от 4 до 0.25 с. Число окон
резко растёт, но число условно независимых фрагментов — намного медленнее. Затем кликнуть по
манёвру: цветные полосы над сигналами показывают, какая часть события копируется.
...
цвета смешаны внутри каждого flight_id и учебная метрика оптимистична. Во втором неизвестен
целый полёт. В третьем тест находится справа по времени и отделён gap.
